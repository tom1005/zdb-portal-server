...
public interface TagRepository extends CrudRepository<Tag, String> {
	...
	@Query(value = "select * from zdb.tag where namespace =:namespace and release_name =:release_name and tag_name = 'data' limit 1", nativeQuery = true)
	Tag findByNamespaceAndReleaseNameForBackupList(@Param("namespace") String namespace, @Param("release_name") String release_name);
