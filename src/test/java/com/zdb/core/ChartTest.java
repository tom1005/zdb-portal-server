...
public class ChartTest {
	...
	public static void main(String[] args) throws Exception {
		...
		//final URI uri = URI.create("file:///home/nexcore/git/charts/stable/mariadb/mariadb-4.0.0.tgz");
		final URI uri = URI.create("http://169.56.70.222:31770/redis-3.3.0.tgz");
